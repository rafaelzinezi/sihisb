		...
		<div id="wrapper">
			...
			<div id="sitio">
				...
				<div id="posts">
					...
					<legend>Atualizado: 18 de julho de 2018</legend>
					...
					<ul class="lista-decorativa">
						...
						<li><a href="javascript: void()" onclick="$(&#39;#selo&#39;).slideToggle()">SIHISB recebe Prêmio Selo de Mérito 2014 no Fórum Nacional de Habitação de Interesse Social.</a></li>
						
						<div id="selo" class="toggleBox" style="display: none;">

							

							<p><b>Sistema de Informação de Habitação de Interesse Social de São Bernardo do campo:</b><br><br>

							• O Sistema de Informações de Habitação de Interesse Social de São Bernardo do Campo – SIHISB da Prefeitura de São Bernardo foi um dos projetos vencedores do prêmio Selo de Mérito 2014 dado pela Associação Brasileira de COHABs e Agentes Públicos de Habitação e pelo Fórum Nacional de Secretários de Habitação e Desenvolvimento Urbano.<br><br>
							
							O Sistema está Implantado desde 2012 em São Bernardo e é resultado da customização do Sistema HABISP da Prefeitura de São Paulo, o que se fez por meio de Termo de Cooperação Técnica entre as duas Prefeituras, com o apoio da Aliança de Cidades e do Banco Mundial; e da base de conhecimento da acerca das necessidades habitacionais do município produzido pela Prefeitura de São Bernardo em 2009 e 2010 por meio do Mapeamento de Assentamentos Precários e do Plano Municipal de Redução de Riscos – PMRR.<br><br>
							
							Ele funciona via web (www.sihisb.saobernardo.sp.gov.br) e possui 4 módulos operacionais em funcionamento: o Módulo A – Mapa dos Assentamentos, que está disponível a toda a sociedade; e três módulos disponíveis para a administração: Módulo B – Mapeamento dos Assentamentos Precários e/ou Irregulares; Módulo C – Cadastro de Famílias vinculadas a intervenções da Política Habitacional; e Módulo D – Renda Abrigo.<br><br>
							
							O prêmio, que será entregue no próximo dia 26 de março por ocasião do 61º Fórum Nacional de Habitação de Interesse Social, foi dado na categoria “Aprimoramento do modelo de gestão para o fortalecimento do Sistema de Habitação de Interesse Social”.<br><br>
							
							Este é um trabalho que envolveu muitos parceiros na sua viabilização, no seu desenvolvimento e agora na sua manutenção e o trabalho de cada um foi fundamental para o Sistema e para o prêmio.<br><br>

							
							<small>(Dados atualizados: março/2014)</small>
					...
					<ul class="lista-decorativa">
						...
						<div id="empe_2_1_01" class="toggleBox" style="display: none;">
							...
							<img src="images/ch_tres_marias_01_01.jpg" class="align-left">
							...
							<p><b>AÇÕES:</b>
								...
								• Trabalho Social com a comunidade, iniciado com a discussão do projeto;<br>
							...
							<p>
								...
								• Obra concluída: 1.236 unidades habitacionais, Parque Três Marias e Centro Comercial entregues.<br>

								• Regularização Fundiária concluída<br>

								• Trabalho Social em andamento, com previsão de conclusão em abril/2017


							</p>

							<small>(Dados atualizados: dezembro/2016)</small>
						...
						<div id="empe_2_1_03" class="toggleBox" style="display: none;">
							...
							<p><b>AÇÕES:</b><br>
								...
								• Destinação de área para implantação do Centro de Educação Unificada – CEU, com recursos da Secretaria de Educação. O equipamento conta com 1292 vagas para alunos de zero a 10 anos, com atividades que vão da creche ao Ensino Fundamental, Alfabetização e Educação de Jovens e Adultos. <br>
							...
							<p><b>ESTÁGIO ATUAL:</b><br>
								...
								• Obra concluída: 540 Unidades Habitacionais entregues. <br>

								• Regularização Fundiária concluída <br>

								• Trabalho Social em andamento, com previsão de conclusão em maio/2017
						...
						<div id="empe_1_1_01" class="toggleBox" style="display: none;">
							...
							<img src="images/ch_j_esmeralda_01_01.jpg" class="align-left">
							...
							<p><b>ESTÁGIO ATUAL:</b><br>
								...
								• Conclusão da Regularização Fundiária prevista para fevereiro/2017<br>

								• Trabalho Social em andamento, com previsão de conclusão em maio/2017<br>

								• 2ª fase: obras em fase de conclusão.
						...
						<div id="empe_2_1_02" class="toggleBox">
							...
							<p><b>AÇÕES:</b><br>
								...
								• Produção de 448 unidades habitacionais, sendo 148 unidades habitacionais tipo casas sobrepostas e 300 unidades habitacionais verticalizadas;<br>
							...
							<p><b>FAMÍLIAS BENEFICIADAS:</b><br>	
								...
								• 2ª etapa - fase 2: 124<br>
								• 2ª etapa - fase 3: 176<br>
							...
							<p><b>ESTÁGIO ATUAL:</b><br>
								...
								• 148 Unidades Habitacionais entregues (80 na 1ª etapa e 68 na 1ª fase da 2ª etapa)
						...
						<div id="empe_2_1_06" class="toggleBox">
							...
							<p><b>ESTÁGIO ATUAL:</b><br>
								...
								• Obra concluída: 22 unidades habitacionais entregues.<br>
								• Conclusão da Regularização Fundiária prevista para março/2017<br>
								• Trabalho Social em andamento, com previsão de conclusão em março/2017
						...
						<div id="empe_1_1_11" class="toggleBox">
							...
							<img src="images/ch_jardim_lavinia_01_01.jpg" class="align-left">
						...
						<div id="empe_2_1_04" class="toggleBox">
							...
							<p><b>ESTÁGIO ATUAL:</b><br>
								...
								<b>1ª fase de obras:</b><br>
								• Obras habitacionais concluídas: 532 unidades entregues<br>
								• Regularização Fundiária concluída<br>
								<b>2ª fase de obras:</b><br>
								• Obras em andamento<br>
								• Entrega parcial do Centro Comercial realizada em dezembro/2016
						...
						<div id="empe_1_1_02" class="toggleBox">
							...
							<p><b>AÇÕES:</b><br>
								...
								• Produção de 876 unidades habitacionais;<br>
							...
							<p><b>ESTÁGIO ATUAL:</b><br>
								...
								• Obras em andamento.Sítio Bom Jesus: Obras de urbanização concluídas; 344 Unidades Habitacionais entregues; construção de centro comercial, CRAS e parque público.
						...
						<div id="empe_1_1_03" class="toggleBox">
							...
							<p><b>ESTÁGIO ATUAL:</b><br>
								...
								• Obras de urbanização concluídas<br>
								• 344 Unidades Habitacionais entregues<br>
								• Construção de Centro Comercial, CRAS e parque público<br>

<div style="clear: both"></div>
<img class="align-left" src="images/Sitio_Bom Jesus_obras_01.jpg"></img>
<div style="clear: both"></div>
						...
						<div id="empe_1_1_04" class="toggleBox">
							...
							<img src="images/urb_integrada_alvarenga_04_01.jpg" class="align-left">
						...
						<div id="empe_1_1_05" class="toggleBox">
							...
							<p><b>ESTÁGIO ATUAL:</b><br>
								...
								• Obras em andamento.<br>
								• Remoções concluídas. 679 famílias reassentadas no Conjunto Habitacional Três Marias
						...
						<div id="empe_1_1_06" class="toggleBox">
							...
							<p><b>ESTÁGIO ATUAL:</b><br>
								...
								• Remoções concluídas. 29 famílias reassentadas no Conjunto Habitacional Três Marias.
						...
						<div id="empe_1_1_07" class="toggleBox">
							...
							<p><b>AÇÕES:</b><br>
								...
								• Produção de 754 unidades habitacionais;<br>

								• Consolidação por urbanização e regularização de 1.804 moradias por meio de infraestrutura compreendendo sistema viário completo, contenções, drenagem, paisagismo, sistema de abastecimento de água, iluminação e urbanismo; <br>
							...
							<p><b>ESTÁGIO ATUAL:</b><br>
								...
								• Obras em andamento. 584 unidades habitacionais entregues.
						...
						<div id="empe_1_1_08" class="toggleBox">
							...
							<img src="images/ch_colina_01_01.jpg" class="align-left">
							...
							<p><b>AÇÕES:</b><br>
								...
								• Produção de 104 unidades habitacionais, sendo 80 unidades habitacionais verticalizadas e 24 unidades sobrepostas;<br>
							...
							<p><b>ESTÁGIO ATUAL:</b><br>
								...
								• Obra concluída: 104 unidades habitacionais entregues e 46 unidades consolidadas.<br>
								• Trabalho Social e Regularização Fundiária em andamento
						...
						<div id="empe_2_1_05" class="toggleBox">
							...
							<img src="images/ch_silvina_audi_01_01.jpg" class="align-left">

							<p><b>OBJETO:</b><br>

								• Urbanização Integrada dos assentamentos precários e/ou irregulares Jardim Silvina, Silvina Audi, Rua Washington Luís, Gaspar de Souza e Bananal. Conta com Conjunto Habitacional de Reassentamento Externo construído no âmbito do PMCMV em terreno desapropriado pela Prefeitura, o Residencial Ponto Alto.
							...
							<p><b>AÇÕES:</b><br>
								...
								• Produção de 416 unidades habitacionais; <br>

								• Consolidação por urbanização e regularização de 2.356 moradias;<br>
								
								• Conta com o apoio de 560 UHs de Conjunto Habitacional de Reassentamento Externo, construído no âmbito do PMCMV;<br>
							...
							<p><b>ESTÁGIO ATUAL:</b><br>
								...
								• Obras em andamento.<br>
								• Entregues até o momento 69 Unidades Habitacionais e 02 Unidades não habitacionais, além das 560 UHs do Residencial Ponto Alto.
						...
						<div id="empe_1_1_09" class="toggleBox">
							...
							<p><b>AÇÕES</b><br>
								...
								• Consolidação por urbanização e regularização de 2452 moradias;<br>
								
								• Conta com o apoio de 420 UHs de Conjunto Habitacional de Reassentamento Externo em construção no âmbito do PMCMV, o Residencial Independência;<br>
							...
							<p><b>ESTÁGIO ATUAL:</b><br>
								...
								• Obras de urbanização em processo de distrato com a empresa <br>
								• MCMV Residencial Independência: Obras suspensas em recontratação pela Caixa<br>
						...
						<div id="empe_1_1_10" class="toggleBox">
							...
							<p><b>AÇÕES</b><br>
								...
								• Produção de 248  unidades habitacionais, sendo 196  no Assentamento Capelinha e 52 no Assentamento Cocaia;<br>
								
								• Produção de 17 unidades comerciais no Assentamento Capelinha;<br>

								• Consolidação por urbanização e regularização de 676  moradias, sendo 608 no Assentamento Capelinha e 68 no Assentamento Cocaia; <br>
							...
							<p><b>ESTÁGIO ATUAL:</b><br>
								...
								• Obras concluídas no Núcleo Cocaia; 52 Unidades Habitacionais entregues<br>
								• Obras em andamento no Núcleo Capelinha. Entregues, até o momento, 12 Unidades Habitacionais.
