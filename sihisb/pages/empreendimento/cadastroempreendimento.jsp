					...
					<%}%>				
						...
						<div>
							...
							<input type="hidden" id="idt_empreendimento" name="idt_empreendimento" value="<%= ((EmpBean)request.getAttribute("Empreend")).getIdt_empreendimento()%>"  <%=(request.getAttribute("update") != null ? "readonly='readonly'" : "") %> >
								...
								<input type="text" id="nome_empreendimento" name="nome_empreendimento" AUTOCOMPLETE=OFF tabindex="01" style="width:400px" value="<%=((EmpBean)request.getAttribute("Empreend")).getNom_empreendimento()%>" />
								<label for="familias_beneficiadas" style="width: 190px">Famílias Beneficiadas</label> 
								<input type="text" class="smallInput" id="familias_beneficiadas" name="familias_beneficiadas" AUTOCOMPLETE=OFF tabindex="02" value="<%=((EmpBean)request.getAttribute("Empreend")).getQtd_familias_atendidas()%>" />
							</p>
						</div>
						<div class="colunas">
							<p>
								<label for="tempo_obra" style="width: 200px">Prazo da obra</label> 
								<input type="text" id="tempo_obra" name="tempo_obra"  AUTOCOMPLETE=OFF tabindex="03" style="width: 170px" value="<%=((EmpBean)request.getAttribute("Empreend")).getQtd_meses_obra() %>" />&nbsp;<i>(meses).</i>
							
							</p>
							<p>
								<label for="agente_financeiro" style="width: 200px">Agente Financeiro</label> 
								<input type="text" id="agente_financeiro" name="agente_financeiro" AUTOCOMPLETE=OFF tabindex="04" style="width: 170px" value="<%=((EmpBean)request.getAttribute("Empreend")).getNom_agente_financeiro()%>"/>
							</p>
						</div>
						<div class="colunas">
							<p>
								<label for="n_contrato" style="width: 200px">Nº do Contrato</label> 
								<input type="text" id="n_contrato" name="n_contrato" AUTOCOMPLETE=OFF tabindex="05" style="width: 170px" value="<%=((EmpBean)request.getAttribute("Empreend")).getNum_contrato()%>"/>
							</p>
							<p>
								<label for="tp_contrato" style="width: 200px">Fonte de Recursos</label> 
								<input type="text" id="tp_contrato" name="tp_contrato" AUTOCOMPLETE=OFF tabindex="06"style="width: 170px" value="<%=((EmpBean)request.getAttribute("Empreend")).getDes_fonte_recurso()%>"/>
							</p>
						</div>
						<div>							
							<p class="width100">
						...
						<div>
							...
							<p class="width100">
								...
								<input type="text" id="protocolo_consulta" name="protocolo_consulta" AUTOCOMPLETE=OFF value="<%=((ContratacaoRecursosBean)request.getAttribute("recursos")).getNum_protocolo_carta_consulta()%>" />
								<label for="n_do_contrato">Nº do Contrato de Recursos</label> 
								<input type="text" id="n_do_contrato" name="n_do_contrato" AUTOCOMPLETE=OFF value="<%=((ContratacaoRecursosBean)request.getAttribute("recursos")).getNum_contrato_recurso()%>"  />
							</p>
						</div>
						...
						<div class="colunas">
							<p class="width100">
								...
								<input type="text" id="vl_contr_repasse_REC" name="vl_contr_repasse_REC"  AUTOCOMPLETE=OFF style="width: 170px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${recursos.vlr_repasse_financiamento_orig}" />" />
								<label for="vl_contr_contrapartida_REC" style="width: 120px">Contrapartida Tesouro&nbsp;<i>R$</i></label> 
								<input type="text" id="contrapartidaTesouro_REC" name="contrapartidaTesouro_REC"  AUTOCOMPLETE=OFF style="width: 170px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${recursos.vlr_contrapartida_tesouro_orig}" />"/>
								<label for="vl_contr_total_REC" style="width: 100px">Valor Total&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contr_total_REC" name="vl_contr_total_REC"  AUTOCOMPLETE=OFF style="width: 170px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${recursos.vlr_total_orig}" />"/>
							</p>
							...
							<p class="width100">
								...
								<input type="text" id="vl_contrapartida_01_REC" name="vl_contrapartida_01_REC"  AUTOCOMPLETE=OFF style="width: 270px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${recursos.vlr_contrapartida_orig_1}" />"/>
								<label for="fonte_contrapartida_01_REC" style="width: 100px">Fonte</label> 
								<input type="text" id="fonte_contrapartida_01_REC" name="fonte_contrapartida_01_REC" AUTOCOMPLETE=OFF style="width: 270px" value="<%=((ContratacaoRecursosBean)request.getAttribute("recursos")).getDes_contrapartida_1()%>"/>
							</p>
							<p class="width100">
								<label for="vl_contrapartida_02_REC" style="width: 210px">Valor&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contrapartida_02_REC" name="vl_contrapartida_02_REC"  AUTOCOMPLETE=OFF style="width: 270px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${recursos.vlr_contrapartida_orig_2}" />" />
								<label for="fonte_contrapartida_02_REC" style="width: 100px">Fonte</label> 
								<input type="text" id="fonte_contrapartida_02_REC" name="fonte_contrapartida_02_REC" AUTOCOMPLETE=OFF style="width: 270px" value="<%=((ContratacaoRecursosBean)request.getAttribute("recursos")).getDes_contrapartida_2()%>"/>
							</p>
							<p class="width100">
								<label for="vl_contrapartida_03_REC" style="width: 210px">Valor&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contrapartida_03_REC" name="vl_contrapartida_03_REC"  AUTOCOMPLETE=OFF style="width: 270px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${recursos.vlr_contrapartida_orig_3}" />"/>
								<label for="fonte_contrapartida_03_REC" style="width: 100px">Fonte</label> 
								<input type="text" id="fonte_contrapartida_03_REC" name="fonte_contrapartida_03_REC" AUTOCOMPLETE=OFF style="width: 270px" value="<%=((ContratacaoRecursosBean)request.getAttribute("recursos")).getDes_contrapartida_3()%>"/>
							</p>
							<p class="width100">
								<label for="vl_contrapartida_04_REC" style="width: 210px">Valor&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contrapartida_04_REC" name="vl_contrapartida_04_REC"  AUTOCOMPLETE=OFF style="width: 270px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${recursos.vlr_contrapartida_orig_4}" />" />
								<label for="fonte_contrapartida_04_REC" style="width: 100px">Fonte</label> 
								<input type="text" id="fonte_contrapartida_04_REC" name="fonte_contrapartida_04_REC" AUTOCOMPLETE=OFF style="width: 270px" value="<%=((ContratacaoRecursosBean)request.getAttribute("recursos")).getDes_contrapartida_4()%>"/>
							</p>
						</div>
						...
						<div class="colunas">
							<p class="width100">
								...
								<input type="text" id="vl_contr_repasse_aditivo_REC" name="vl_contr_repasse_aditivo_REC"  AUTOCOMPLETE=OFF style="width: 170px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${recursos.vlr_repasse_financiamento_adt}" />" />
								<label for="contrTesouroAdt_REC" style="width: 120px">Contrapartida Tesouro&nbsp;<i>R$</i></label> 
								<input type="text" id="contrTesouroAdt_REC" name="contrTesouroAdt_REC"  AUTOCOMPLETE=OFF style="width: 170px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${recursos.vlr_contrapartida_tesouro_adt}" />"/>
								<label for="vl_contr_total_aditivo_REC" style="width: 100px">Valor Total&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contr_total_aditivo_REC" name="vl_contr_total_aditivo_REC"  AUTOCOMPLETE=OFF style="width: 170px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${recursos.vlr_total_adt}" />"/>
							</p>
							<legend class="legend2">Contrapartida Outras Fontes</legend>
							<p class="width100">
								<label for="vl_contrapartida_01_aditivo_REC" style="width: 210px">Valor&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contrapartida_01_aditivo_REC" name="vl_contrapartida_01_aditivo_REC"  AUTOCOMPLETE=OFF style="width: 270px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${recursos.vlr_contrapartida_adt_1}" />"/>
								<label for="fonte_contrapartida_01_aditivo_REC" style="width: 100px">Fonte</label> 
								<input type="text" id="fonte_contrapartida_01_aditivo_REC" name="fonte_contrapartida_01_aditivo_REC" AUTOCOMPLETE=OFF style="width: 270px" value="<%=((ContratacaoRecursosBean)request.getAttribute("recursos")).getDes_contrapartida_adt_1()%>"/>
							</p>
							<p class="width100">
								<label for="vl_contrapartida_02_aditivo_REC" style="width: 210px">Valor&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contrapartida_02_aditivo_REC" name="vl_contrapartida_02_aditivo_REC"  AUTOCOMPLETE=OFF style="width: 270px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${recursos.vlr_contrapartida_adt_2}" />"/>
								<label for="fonte_contrapartida_02_aditivo_REC" style="width: 100px">Fonte</label> 
								<input type="text" id="fonte_contrapartida_02_aditivo_REC" name="fonte_contrapartida_02_aditivo_REC" AUTOCOMPLETE=OFF style="width: 270px" value="<%=((ContratacaoRecursosBean)request.getAttribute("recursos")).getDes_contrapartida_adt_2()%>" />
							</p>
							<p class="width100">
								<label for="vl_contrapartida_03_aditivo_REC" style="width: 210px">Valor&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contrapartida_03_aditivo_REC" name="vl_contrapartida_03_aditivo_REC"  AUTOCOMPLETE=OFF style="width: 270px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${recursos.vlr_contrapartida_adt_3}" />"/>
								<label for="fonte_contrapartida_03_aditivo_REC" style="width: 100px">Fonte</label> 
								<input type="text" id="fonte_contrapartida_03_aditivo_REC" name="fonte_contrapartida_03_aditivo_REC" AUTOCOMPLETE=OFF style="width: 270px" value="<%=((ContratacaoRecursosBean)request.getAttribute("recursos")).getDes_contrapartida_adt_3()%>" />
							</p>
							<p class="width100">
								<label for="vl_contrapartida_04_aditivo_REC" style="width: 210px">Valor&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contrapartida_04_aditivo_REC" name="vl_contrapartida_04_aditivo_REC"  AUTOCOMPLETE=OFF style="width: 270px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${recursos.vlr_contrapartida_adt_4}" />"/>
								<label for="fonte_contrapartida_04_aditivo_REC" style="width: 100px">Fonte</label> 
								<input type="text" id="fonte_contrapartida_04_aditivo_REC" name="fonte_contrapartida_04_aditivo_REC" AUTOCOMPLETE=OFF style="width: 270px" value="<%=((ContratacaoRecursosBean)request.getAttribute("recursos")).getDes_contrapartida_adt_4()%>"/>
							</p>
						</div>
						...
						<div>
							...
							<p class="width100">
								...
								<input type="text" id="prevista_contrat_obras" name="prevista_contrat_obras" AUTOCOMPLETE=OFF value="<%=((ContratacaoObraBean)request.getAttribute("obra")).getDat_ois_prevista_para()%>" />
								<label for="assinada_contrat_obras" style="width: 120px">Assinada em</label> 
								<input type="text" id="assinada_contrat_obras" name="assinada_contrat_obras" AUTOCOMPLETE=OFF value="<%=((ContratacaoObraBean)request.getAttribute("obra")).getDat_ois_assinada_em()%>"/>
							</p>
							
							<p class="width100">
								<label for="processo_adm_obra" style="width: 170px">Nº do Processo Administrativo</label> 
								<input type="text" id="processo_adm_obra" name="processo_adm_obra" AUTOCOMPLETE=OFF value="<%=((ContratacaoObraBean)request.getAttribute("obra")).getNum_processo_adm()%>"/>
								<label for="licitacao_obra" style="width: 120px">Nº do Processo Licitação</label> 
								<input type="text" id="licitacao_obra" name="licitacao_obra" AUTOCOMPLETE=OFF value="<%=((ContratacaoObraBean)request.getAttribute("obra")).getNum_processo_licitacao()%>"/>
							</p>
							<p class="width100">
								<label for="contrato_obra" style="width: 170px">Nº do Contrato</label> 
								<input type="text" id="contrato_obra" name="contrato_obra" AUTOCOMPLETE=OFF value="<%=((ContratacaoObraBean)request.getAttribute("obra")).getNum_contrato()%>" />
							</p>
						...
						<div class="colunas">
							<p class="width100">
								...
								<input type="text" id="vl_contr_repasse_OBRA" name="vl_contr_repasse_OBRA"  AUTOCOMPLETE=OFF style="width: 170px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${obra.vlr_repasse_financiamento_orig}" />"/>
								<label for="vl_contr_contrapartida_OBRA" style="width: 120px">Contrapartida Tesouro&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contr_contrapartida_OBRA" name="vl_contr_contrapartida_OBRA"  AUTOCOMPLETE=OFF style="width: 170px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${obra.vlr_contrapartida_tesouro_orig}"/>"/>
								<label for="vl_contr_total_OBRA" style="width: 100px">Valor Total&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contr_total_OBRA" name="vl_contr_total_OBRA"  AUTOCOMPLETE=OFF style="width: 170px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${obra.vlr_total_orig}"/>"/>
							</p>
							<legend class="legend2">Contrapartida Outras Fontes</legend>
							<p class="width100">
								<label for="vl_contrapartida_01_OBRA" style="width: 210px">Valor&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contrapartida_01_OBRA" name="vl_contrapartida_01_OBRA"  AUTOCOMPLETE=OFF style="width: 270px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${obra.vlr_contrapartida_orig_1}"/>"/>
								<label for="fonte_contrapartida_01_OBRA" style="width: 100px">Fonte</label> 
								<input type="text" id="fonte_contrapartida_01_OBRA" name="fonte_contrapartida_01_OBRA" AUTOCOMPLETE=OFF style="width: 270px" value="<%=((ContratacaoObraBean)request.getAttribute("obra")).getDes_contrapartida_1()%>"/>
							</p>
							<p class="width100">
								<label for="vl_contrapartida_02_OBRA" style="width: 210px">Valor&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contrapartida_02_OBRA" name="vl_contrapartida_02_OBRA"  AUTOCOMPLETE=OFF style="width: 270px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${obra.vlr_contrapartida_orig_2}"/>"/>
								<label for="fonte_contrapartida_02_OBRA" style="width: 100px">Fonte</label> 
								<input type="text" id="fonte_contrapartida_02_OBRA" name="fonte_contrapartida_02_OBRA" AUTOCOMPLETE=OFF style="width: 270px" value="<%=((ContratacaoObraBean)request.getAttribute("obra")).getDes_contrapartida_2()%>"/>
							</p>
							<p class="width100">
								<label for="vl_contrapartida_03_OBRA" style="width: 210px">Valor&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contrapartida_03_OBRA" name="vl_contrapartida_03_OBRA"  AUTOCOMPLETE=OFF style="width: 270px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${obra.vlr_contrapartida_orig_3}"/>" />
								<label for="fonte_contrapartida_03_OBRA" style="width: 100px">Fonte</label> 
								<input type="text" id="fonte_contrapartida_03_OBRA" name="fonte_contrapartida_03_OBRA" AUTOCOMPLETE=OFF style="width: 270px" value="<%=((ContratacaoObraBean)request.getAttribute("obra")).getDes_contrapartida_3()%>" />
							</p>
							<p class="width100">
								<label for="vl_contrapartida_04_OBRA" style="width: 210px">Valor&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contrapartida_04_OBRA" name="vl_contrapartida_04_OBRA"  AUTOCOMPLETE=OFF style="width: 270px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${obra.vlr_contrapartida_orig_4}"/>"/>
								<label for="fonte_contrapartida_04_OBRA" style="width: 100px">Fonte</label> 
								<input type="text" id="fonte_contrapartida_04_OBRA" name="fonte_contrapartida_04_OBRA" AUTOCOMPLETE=OFF style="width: 270px" value="<%=((ContratacaoObraBean)request.getAttribute("obra")).getDes_contrapartida_4()%>"/>
							</p>
						</div>
						...
						<div class="colunas">
							<p class="width100">
								...
								<input type="text" id="vl_contr_repasse_aditivo_OBRA" name="vl_contr_repasse_aditivo_OBRA"  AUTOCOMPLETE=OFF style="width: 170px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${obra.vlr_repasse_financiamento_adt}" />"/>
								<label for="vl_contr_contrapartida_adObra_OBRA" style="width: 120px">Contrapartida Tesouro&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contr_contrapartida_adObra_OBRA" name="vl_contr_contrapartida_adObra_OBRA"  AUTOCOMPLETE=OFF style="width: 170px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${obra.vlr_contrapartida_tesouro_adt}" />"/>
								<label for="vl_contr_total_aditivo_OBRA" style="width: 100px">Valor Total&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contr_total_aditivo_OBRA" name="vl_contr_total_aditivo_OBRA"  AUTOCOMPLETE=OFF style="width: 170px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${obra.vlr_total_adt}" />" />
							</p>
							<legend class="legend2">Contrapartida Outras Fontes</legend>
							<p class="width100">
								<label for="vl_contrapartida_01_aditivo_OBRA" style="width: 210px">Valor&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contrapartida_01_aditivo_OBRA" name="vl_contrapartida_01_aditivo_OBRA"  AUTOCOMPLETE=OFF style="width: 270px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${obra.vlr_contrapartida_adt_1}" />"/>
								<label for="fonte_contrapartida_01_aditivo_OBRA" style="width: 100px">Fonte</label> 
								<input type="text" id="fonte_contrapartida_01_aditivo_OBRA" name="fonte_contrapartida_01_aditivo_OBRA" AUTOCOMPLETE=OFF style="width: 270px" value="<%=((ContratacaoObraBean)request.getAttribute("obra")).getDes_contrapartida_adt_1()%>" />
							</p>
							<p class="width100">
								<label for="vl_contrapartida_02_aditivo_OBRA" style="width: 210px">Valor&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contrapartida_02_aditivo_OBRA" name="vl_contrapartida_02_aditivo_OBRA"  AUTOCOMPLETE=OFF style="width: 270px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${obra.vlr_contrapartida_adt_2}" />" />
								<label for="fonte_contrapartida_02_aditivo_OBRA" style="width: 100px">Fonte</label> 
								<input type="text" id="fonte_contrapartida_02_aditivo_OBRA" name="fonte_contrapartida_02_aditivo_OBRA" AUTOCOMPLETE=OFF style="width: 270px" value="<%=((ContratacaoObraBean)request.getAttribute("obra")).getDes_contrapartida_adt_2()%>" />
							</p>
							<p class="width100">
								<label for="vl_contrapartida_03_aditivo_OBRA" style="width: 210px">Valor&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contrapartida_03_aditivo_OBRA" name="vl_contrapartida_03_aditivo_OBRA"  AUTOCOMPLETE=OFF style="width: 270px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${obra.vlr_contrapartida_adt_3}" />"/>
								<label for="fonte_contrapartida_03_aditivo_OBRA" style="width: 100px">Fonte</label> 
								<input type="text" id="fonte_contrapartida_03_aditivo_OBRA" name="fonte_contrapartida_03_aditivo_OBRA" AUTOCOMPLETE=OFF style="width: 270px" value="<%=((ContratacaoObraBean)request.getAttribute("obra")).getDes_contrapartida_adt_3()%>" />
							</p>
							<p class="width100">
								<label for="vl_contrapartida_04_aditivo_OBRA" style="width: 210px">Valor&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contrapartida_04_aditivo_OBRA" name="vl_contrapartida_04_aditivo_OBRA"  AUTOCOMPLETE=OFF style="width: 270px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${obra.vlr_contrapartida_adt_4}" />" />
								<label for="fonte_contrapartida_04_aditivo_OBRA" style="width: 100px">Fonte</label> 
								<input type="text" id="fonte_contrapartida_04_aditivo_OBRA" name="fonte_contrapartida_04_aditivo_OBRA" AUTOCOMPLETE=OFF style="width: 270px" value="<%=((ContratacaoObraBean)request.getAttribute("obra")).getDes_contrapartida_adt_4()%>"/>
							</p>
						</div>
						...
						<div>
							...
							<p class="width100">
								...
								<input type="text" id="prevista_trab_social" name="prevista_trab_social" AUTOCOMPLETE=OFF value="<%=((ContratacaoTrabSocial)request.getAttribute("trabsocial")).getDat_ois_prevista_para()%>"/>
								<label for="assinada_trab_social" style="width: 120px">Assinada em</label> 
								<input type="text" id="assinada_trab_social" name="assinada_trab_social" AUTOCOMPLETE=OFF value="<%=((ContratacaoTrabSocial)request.getAttribute("trabsocial")).getDat_ois_assinada_em()%>" />
							</p>
							<p class="width100">
								<label for="processo_adm_trabobra" style="width: 170px">Nº do Processo Administrativo</label> 
								<input type="text" id="processo_adm_trabobra" name="processo_adm_trabobra" AUTOCOMPLETE=OFF value="<%=((ContratacaoTrabSocial)request.getAttribute("trabsocial")).getNum_processo_adm()%>"/>
								<label for="licitacao_trabobra" style="width: 120px">Nº do Processo Licitação</label> 
								<input type="text" id="licitacao_trabobra" name="licitacao_trabobra" AUTOCOMPLETE=OFF  value="<%=((ContratacaoTrabSocial)request.getAttribute("trabsocial")).getNum_processo_licitacao()%>"/>
							</p>
							<p class="width100">
								<label for="contrato_trabobra" style="width: 170px">Nº do Contrato</label> 
								<input type="text" id="contrato_trabobra" name="contrato_trabobra" AUTOCOMPLETE=OFF value="<%=((ContratacaoTrabSocial)request.getAttribute("trabsocial")).getNum_contrato()%>"/>
							</p>
						</div>
						<legend class="legend2">Valores Contratados - Original</legend>
						<div class="colunas">
							<p class="width100">
								...
								<input type="text" id="vl_contr_repasse_TRAB" name="vl_contr_repasse_TRAB"  AUTOCOMPLETE=OFF style="width: 170px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${trabsocial.vlr_repasse_financiamento_orig}" />"/>
								<label for="vl_contr_contrapartida_TRAB" style="width: 120px">Contrapartida Tesouro&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contr_contrapartida_TRAB" name="vl_contr_contrapartida_TRAB"  AUTOCOMPLETE=OFF style="width: 170px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${trabsocial.vlr_contrapartida_tesouro_orig}" />"/>
								<label for="vl_contr_total_TRAB" style="width: 100px">Valor Total&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contr_total_TRAB" name="vl_contr_total_TRAB"  AUTOCOMPLETE=OFF style="width: 170px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${trabsocial.vlr_total_orig}" />"/>
							</p>
							<legend class="legend2">Contrapartida Outras Fontes</legend>
							<p class="width100">
								<label for="vl_contrapartida_01_TRAB" style="width: 210px">Valor&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contrapartida_01_TRAB" name="vl_contrapartida_01_TRAB"  AUTOCOMPLETE=OFF style="width: 270px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${trabsocial.vlr_contrapartida_orig_1}"/>"/>
								<label for="fonte_contrapartida_01_TRAB" style="width: 100px">Fonte</label> 
								<input type="text" id="fonte_contrapartida_01_TRAB" name="fonte_contrapartida_01_TRAB" AUTOCOMPLETE=OFF style="width: 270px" value="<%=((ContratacaoTrabSocial)request.getAttribute("trabsocial")).getDes_contrapartida_1()%>"/>
							</p>
							<p class="width100">
								<label for="vl_contrapartida_02_TRAB" style="width: 210px">Valor&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contrapartida_02_TRAB" name="vl_contrapartida_02_TRAB"   AUTOCOMPLETE=OFF style="width: 270px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${trabsocial.vlr_contrapartida_orig_2}"/>"/>
								<label for="fonte_contrapartida_02_TRAB" style="width: 100px">Fonte</label> 
								<input type="text" id="fonte_contrapartida_02_TRAB" name="fonte_contrapartida_02_TRAB" AUTOCOMPLETE=OFF style="width: 270px" value="<%=((ContratacaoTrabSocial)request.getAttribute("trabsocial")).getDes_contrapartida_2()%>"/>
							</p>
							<p class="width100">
								<label for="vl_contrapartida_03_TRAB" style="width: 210px">Valor&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contrapartida_03_TRAB" name="vl_contrapartida_03_TRAB"  AUTOCOMPLETE=OFF style="width: 270px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${trabsocial.vlr_contrapartida_orig_3}"/>"/>
								<label for="fonte_contrapartida_03_TRAB" style="width: 100px">Fonte</label> 
								<input type="text" id="fonte_contrapartida_03_TRAB" name="fonte_contrapartida_03_TRAB" AUTOCOMPLETE=OFF style="width: 270px" value="<%=((ContratacaoTrabSocial)request.getAttribute("trabsocial")).getDes_contrapartida_3()%>"/>
							</p>
							<p class="width100">
								<label for="vl_contrapartida_04_TRAB" style="width: 210px">Valor&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contrapartida_04_TRAB" name="vl_contrapartida_04_TRAB"  AUTOCOMPLETE=OFF style="width: 270px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${trabsocial.vlr_contrapartida_orig_4}"/>"/>
								<label for="fonte_contrapartida_04_TRAB" style="width: 100px">Fonte</label> 
								<input type="text" id="fonte_contrapartida_04_TRAB" name="fonte_contrapartida_04_TRAB" AUTOCOMPLETE=OFF style="width: 270px" value="<%=((ContratacaoTrabSocial)request.getAttribute("trabsocial")).getDes_contrapartida_4()%>"/>
							</p>
						</div>
						<legend class="legend2">Valores Contratados - Com Aditivo</legend>
						<div class="colunas">
							<p class="width100">
								...
								<input type="text" id="vl_contr_repasse_aditivo_TRAB" name="vl_contr_repasse_aditivo_TRAB"  AUTOCOMPLETE=OFF style="width: 170px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${trabsocial.vlr_repasse_financiamento_adt}"/>"/>
								<label for="vl_contr_contrapartida_tsocial_TRAB" style="width: 120px">Contrapartida Tesouro&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contr_contrapartida_tsocial_TRAB" name="vl_contr_contrapartida_tsocial_TRAB"  AUTOCOMPLETE=OFF style="width: 170px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${trabsocial.vlr_contrapartida_tesouro_adt}"/>"/>
								<label for="vl_contr_total_aditivo_TRAB" style="width: 100px">Valor Total&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contr_total_aditivo_TRAB" name="vl_contr_total_aditivo_TRAB"  AUTOCOMPLETE=OFF style="width: 170px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${trabsocial.vlr_total_adt}"/>"/>
							</p>
							<legend class="legend2">Contrapartida Outras Fontes</legend>
							<p class="width100">
								<label for="vl_contrapartida_01_aditivo_TRAB" style="width: 210px">Valor&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contrapartida_01_aditivo_TRAB" name="vl_contrapartida_01_aditivo_TRAB"  AUTOCOMPLETE=OFF style="width: 270px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${trabsocial.vlr_contrapartida_adt_1}"/>"/>
								<label for="fonte_contrapartida_01_aditivo_TRAB" style="width: 100px">Fonte</label> 
								<input type="text" id="fonte_contrapartida_01_aditivo_TRAB" name="fonte_contrapartida_01_aditivo_TRAB" AUTOCOMPLETE=OFF style="width: 270px" value="<%=((ContratacaoTrabSocial)request.getAttribute("trabsocial")).getDes_contrapartida_adt_1()%>" />
							</p>
							<p class="width100">
								<label for="vl_contrapartida_02_aditivo_TRAB" style="width: 210px">Valor&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contrapartida_02_aditivo_TRAB" name="vl_contrapartida_02_aditivo_TRAB"  AUTOCOMPLETE=OFF style="width: 270px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${trabsocial.vlr_contrapartida_adt_2}"/>"/>
								<label for="fonte_contrapartida_02_aditivo_TRAB" style="width: 100px">Fonte</label> 
								<input type="text" id="fonte_contrapartida_02_aditivo_TRAB" name="fonte_contrapartida_02_aditivo_TRAB" AUTOCOMPLETE=OFF style="width: 270px" value="<%=((ContratacaoTrabSocial)request.getAttribute("trabsocial")).getDes_contrapartida_adt_2()%>"/>
							</p>
							<p class="width100">
								<label for="vl_contrapartida_03_aditivo_TRAB" style="width: 210px">Valor&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contrapartida_03_aditivo_TRAB" name="vl_contrapartida_03_aditivo_TRAB"  AUTOCOMPLETE=OFF style="width: 270px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${trabsocial.vlr_contrapartida_adt_3}"/>"/>
								<label for="fonte_contrapartida_03_aditivo_TRAB" style="width: 100px">Fonte</label> 
								<input type="text" id="fonte_contrapartida_03_aditivo_TRAB" name="fonte_contrapartida_03_aditivo_TRAB" AUTOCOMPLETE=OFF style="width: 270px" value="<%=((ContratacaoTrabSocial)request.getAttribute("trabsocial")).getDes_contrapartida_adt_3()%>"/>
							</p>
							<p class="width100">
								<label for="vl_contrapartida_04_aditivo_TRAB" style="width: 210px">Valor&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contrapartida_04_aditivo_TRAB" name="vl_contrapartida_04_aditivo_TRAB"  AUTOCOMPLETE=OFF style="width: 270px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${trabsocial.vlr_contrapartida_adt_4}"/>"/>
								<label for="fonte_contrapartida_04_aditivo_TRAB" style="width: 100px">Fonte</label> 
								<input type="text" id="fonte_contrapartida_04_aditivo_TRAB" name="fonte_contrapartida_04_aditivo_TRAB" AUTOCOMPLETE=OFF style="width: 270px" value="<%=((ContratacaoTrabSocial)request.getAttribute("trabsocial")).getDes_contrapartida_adt_4()%>"/>
							</p>
						</div>
						...
						<div>
							...
							<p class="width100">
								...
								<input type="text" id="prevista_reg_fund" name="prevista_reg_fund" AUTOCOMPLETE=OFF value="<%=((ContratacaoRegFunBean)request.getAttribute("regfundiaria")).getDat_ois_prevista_para()%>"/>
								<label for="assinada_reg_fund" style="width: 120px">Assinada em</label> 
								<input type="text" id="assinada_reg_fund" name="assinada_reg_fund" AUTOCOMPLETE=OFF value="<%=((ContratacaoRegFunBean)request.getAttribute("regfundiaria")).getDat_ois_assinada_em()%>"/>
							</p>
							<p class="width100">
								<label for="processo_adm_reg_fund" style="width: 170px">Nº do Processo Administrativo</label> 
								<input type="text" id="processo_adm_reg_fund" name="processo_adm_reg_fund" AUTOCOMPLETE=OFF value="<%=((ContratacaoRegFunBean)request.getAttribute("regfundiaria")).getNum_processo_adm()%>"/>
								<label for="licitacao_reg_fund" style="width: 120px">Nº do Processo Licitação</label> 
								<input type="text" id="licitacao_reg_fund" name="licitacao_reg_fund" AUTOCOMPLETE=OFF value="<%=((ContratacaoRegFunBean)request.getAttribute("regfundiaria")).getNum_processo_licitacao()%>"/>
							</p>
							<p class="width100">
								<label for="contrato_reg_fund" style="width: 170px">Nº do Contrato</label> 
								<input type="text" id="contrato_reg_fund" name="contrato_reg_fund" AUTOCOMPLETE=OFF value="<%=((ContratacaoRegFunBean)request.getAttribute("regfundiaria")).getNum_contrato()%>"/>
							</p>
						</div>
						<legend class="legend2">Valores Contratados - Original</legend>
						<div class="colunas">
							<p class="width100">
								...
								<input type="text" id="vl_contr_repasse" name="vl_contr_repasse"  AUTOCOMPLETE=OFF style="width: 170px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${regfundiaria.vlr_repasse_financiamento_orig}"/>" />
								<label for="vl_contr_contrapartida" style="width: 120px">Contrapartida Tesouro&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contr_contrapartida" name="vl_contr_contrapartida"  AUTOCOMPLETE=OFF style="width: 170px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${regfundiaria.vlr_contrapartida_tesouro_orig}"/>"/>
								<label for="vl_contr_total" style="width: 100px">Valor Total&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contr_total" name="vl_contr_total"  AUTOCOMPLETE=OFF style="width: 170px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${regfundiaria.vlr_total_orig}"/>" />
							</p>
							<legend class="legend2">Contrapartida Outras Fontes</legend>
							<p class="width100">
								<label for="vl_contrapartida_01" style="width: 210px">Valor&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contrapartida_01" name="vl_contrapartida_01"  AUTOCOMPLETE=OFF style="width: 270px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${regfundiaria.vlr_contrapartida_orig_1}"/>"/>
								<label for="fonte_contrapartida_01" style="width: 100px">Fonte</label> 
								<input type="text" id="fonte_contrapartida_01" name="fonte_contrapartida_01" AUTOCOMPLETE=OFF style="width: 270px" value="<%=((ContratacaoRegFunBean)request.getAttribute("regfundiaria")).getDes_contrapartida_1()%>"/>
							</p>
							<p class="width100">
								<label for="vl_contrapartida_02" style="width: 210px">Valor&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contrapartida_02" name="vl_contrapartida_02"  AUTOCOMPLETE=OFF style="width: 270px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${regfundiaria.vlr_contrapartida_orig_2}"/>"/>
								<label for="fonte_contrapartida_02" style="width: 100px">Fonte</label> 
								<input type="text" id="fonte_contrapartida_02" name="fonte_contrapartida_02"  AUTOCOMPLETE=OFF style="width: 270px" value="<%=((ContratacaoRegFunBean)request.getAttribute("regfundiaria")).getDes_contrapartida_2()%>"/>
							</p>
							<p class="width100">
								<label for="vl_contrapartida_03" style="width: 210px">Valor&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contrapartida_03" name="vl_contrapartida_03"  AUTOCOMPLETE=OFF style="width: 270px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${regfundiaria.vlr_contrapartida_orig_3}"/>"/>
								<label for="fonte_contrapartida_03" style="width: 100px">Fonte</label> 
								<input type="text" id="fonte_contrapartida_03" name="fonte_contrapartida_03" AUTOCOMPLETE=OFF style="width: 270px" value="<%=((ContratacaoRegFunBean)request.getAttribute("regfundiaria")).getDes_contrapartida_3()%>" />
							</p>
							<p class="width100">
								<label for="vl_contrapartida_04" style="width: 210px">Valor&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contrapartida_04" name="vl_contrapartida_04"  AUTOCOMPLETE=OFF style="width: 270px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${regfundiaria.vlr_contrapartida_orig_4}"/>"/>
								<label for="fonte_contrapartida_04" style="width: 100px">Fonte</label> 
								<input type="text" id="fonte_contrapartida_04" name="fonte_contrapartida_04" AUTOCOMPLETE=OFF style="width: 270px" value="<%=((ContratacaoRegFunBean)request.getAttribute("regfundiaria")).getDes_contrapartida_4()%>"/>
							</p>
						</div>
						<legend class="legend2">Valores Contratados - Com Aditivo</legend>
						<div class="colunas">
							<p class="width100">
								...
								<input type="text" id="vl_contr_repasse_aditivo" name="vl_contr_repasse_aditivo"  AUTOCOMPLETE=OFF style="width: 170px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${regfundiaria.vlr_repasse_financiamento_adt}"/>"/>
								<label for="vl_contr_contrapartida_aditivo" style="width: 120px">Contrapartida Tesouro&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contr_contrapartida_aditivo" name="vl_contr_contrapartida_aditivo"  AUTOCOMPLETE=OFF style="width: 170px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${regfundiaria.vlr_contrapartida_tesouro_adt}"/>"/>
								<label for="vl_contr_total_aditivo" style="width: 100px">Valor Total&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contr_total_aditivo" name="vl_contr_total_aditivo"  AUTOCOMPLETE=OFF style="width: 170px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${regfundiaria.vlr_total_adt}"/>" />
							</p>
							<legend class="legend2">Contrapartida Outras Fontes</legend>
							<p class="width100">
								<label for="vl_contrapartida_01_aditivo" style="width: 210px">Valor&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contrapartida_01_aditivo" name="vl_contrapartida_01_aditivo"  AUTOCOMPLETE=OFF style="width: 270px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${regfundiaria.vlr_contrapartida_adt_1}"/>"/>
								<label for="fonte_contrapartida_01_aditivo" style="width: 100px">Fonte</label> 
								<input type="text" id="fonte_contrapartida_01_aditivo" name="fonte_contrapartida_01_aditivo" AUTOCOMPLETE=OFF style="width: 270px" value="<%=((ContratacaoRegFunBean)request.getAttribute("regfundiaria")).getDes_contrapartida_adt_1()%>"/>
							</p>
							<p class="width100">
								<label for="vl_contrapartida_02_aditivo" style="width: 210px">Valor&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contrapartida_02_aditivo" name="vl_contrapartida_02_aditivo"  AUTOCOMPLETE=OFF style="width: 270px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${regfundiaria.vlr_contrapartida_adt_2}"/>"/>
								<label for="fonte_contrapartida_02_aditivo" style="width: 100px">Fonte</label> 
								<input type="text" id="fonte_contrapartida_02_aditivo" name="fonte_contrapartida_02_aditivo" AUTOCOMPLETE=OFF style="width: 270px" value="<%=((ContratacaoRegFunBean)request.getAttribute("regfundiaria")).getDes_contrapartida_adt_2()%>"/>
							</p>
							<p class="width100">
								<label for="vl_contrapartida_03_aditivo" style="width: 210px">Valor&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contrapartida_03_aditivo" name="vl_contrapartida_03_aditivo"  AUTOCOMPLETE=OFF style="width: 270px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${regfundiaria.vlr_contrapartida_adt_3}"/>"/>
								<label for="fonte_contrapartida_03_aditivo" style="width: 100px">Fonte</label> 
								<input type="text" id="fonte_contrapartida_03_aditivo" name="fonte_contrapartida_03_aditivo" AUTOCOMPLETE=OFF style="width: 270px" value="<%=((ContratacaoRegFunBean)request.getAttribute("regfundiaria")).getDes_contrapartida_adt_3()%>"/>
							</p>
							<p class="width100">
								<label for="vl_contrapartida_04_aditivo" style="width: 210px">Valor&nbsp;<i>R$</i></label> 
								<input type="text" id="vl_contrapartida_04_aditivo" name="vl_contrapartida_04_aditivo"  AUTOCOMPLETE=OFF style="width: 270px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${regfundiaria.vlr_contrapartida_adt_4}"/>"/>
								<label for="fonte_contrapartida_04_aditivo" style="width: 100px">Fonte</label> 
								<input type="text" id="fonte_contrapartida_04_aditivo" name="fonte_contrapartida_04_aditivo" AUTOCOMPLETE=OFF style="width: 270px" value="<%=((ContratacaoRegFunBean)request.getAttribute("regfundiaria")).getDes_contrapartida_adt_4()%>"/>
							</p>
						</div>
						...
						<div>
							<p class="width100">
								...
								<input type="text" id="ex_valor_total" name="ex_valor_total"  AUTOCOMPLETE=OFF style="width: 170px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${Empreend.vlr_total_exec_fisico_financ}"/>"/>
								<label for="ex_acumulado" style="width: 120px">Acumulado&nbsp;<i>R$</i></label> 
								<input type="text" id="ex_acumulado" name="ex_acumulado"  AUTOCOMPLETE=OFF style="width: 170px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${Empreend.vlr_acumul_exec_fisico_financ}"/>"/>
								<label for="ex_saldo" style="width: 100px">Saldo&nbsp;<i>R$</i></label> 
								<input type="text" id="ex_saldo" name="ex_saldo"  AUTOCOMPLETE=OFF style="width: 170px" value="<fmt:formatNumber maxFractionDigits="2" minFractionDigits="2" value="${Empreend.vlr_saldo_exec_fisico_financ}"/>"/>
							</p>
						</div>
